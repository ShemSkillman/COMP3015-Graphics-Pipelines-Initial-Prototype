...
Scene_HDR::Scene_HDR() : plane(20.0f, 50.0f, 1, 1), teapot(14, mat4(1.0f)), sphere(2.0f, 50, 50)
{
}
...
{
	try {
		prog.compileShader("shader/hdr_shader.vert");
		prog.compileShader("shader/hdr_shader.frag");
		prog.link();
		prog.use();
